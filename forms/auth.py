...
class LoginForm(FlaskForm):
    """ログインフォーム"""
    username = StringField('ユーザー名', validators=[DataRequired(), Length(1, 50)])
...
class SignupForm(FlaskForm):
    """サインアップフォーム"""
    username = StringField('ユーザー名', validators=[DataRequired(), Length(min=4, max=50, message='ユーザー名は4文字以上50文字以下で入力してください。')])
